...
unsafe fn choose_arb_pixel_format_id(
    ...
    let descriptor = {
        ...
        if extensions.split(' ').any(|i| i == "WGL_EXT_colorspace") {
        ...
        } else if extensions.split(' ').any(|i| i == "WGL_ARB_framebuffer_sRGB") {
...
unsafe fn choose_arb_pixel_format(
    ...
    let pf_desc = PixelFormat {
        ...
        srgb: if extensions.split(' ').any(|i| i == "WGL_ARB_framebuffer_sRGB") {
            ...
            .split(' ')
            .any(|i| i == "WGL_EXT_framebuffer_sRGB" || i == "WGL_EXT_colorspace")
        {
